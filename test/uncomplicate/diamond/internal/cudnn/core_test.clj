  ...
  (let [T 2
    ...
    (with-release [cudnn-hdl (cudnn-handle default-stream)
      ...
      (facts "CUDA RNN basic functionality."
             ...
             (rnn-fwd cudnn-hdl rnn-desc :inference dev-seq-lengths rnn-tn-desc gpu-x
  ...
  (let [T 2
    ...
    (with-release [cudnn-hdl (cudnn-handle default-stream)
      ...
      (facts "CUDA GRU training."
             ...
             (seq (memcpy-host! gpu-w (float-array 61))) ;;TODO doesn't match DNNL, probably due to different layouts
