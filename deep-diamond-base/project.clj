...
(defproject org.uncomplicate/deep-diamond-base "0.47.0"
  ...
  :profiles {:dev [:dev/all ~(leiningen.core.utils/get-os)]
             ...
             :linux {:dependencies [[org.uncomplicate/neanderthal-openblas "0.66.1"]
                                    [org.bytedeco/openblas "0.3.34-1.5.14" :classifier "linux-x86_64"]]}
             :windows {:dependencies [[org.uncomplicate/neanderthal-openblas "0.66.1"]
